...
export default function PublicSite() {
  ...
  return (
    <>
      ...
      <main>
        <section className="hero" id="home">
          <div className="hero-copy">
            ...
            <p>
              Personalized online lessons to help you reach your goals. Flexible
              schedule, one-on-one guidance.
            </p>
            <div className="hero-actions">
              <button className="btn primary xl" onClick={() => setMode('register')}>
                Book a Session
              </button>
              <a className="btn secondary xl" href="#about">
                View Schedule
              </a>
            </div>
          </div>
          ...
          <div className="hero-image">
            <img src={hero} alt="Teacher and student online" />
          </div>
        </section>
        ...
        <section className="feature-strip">
          ...
          <Feature
            ...
            text="Book anytime"
          />
          <Feature icon={<ShieldCheck />} title="Secure Payment" text="Safe and easy" />
          <Feature
            icon={<Sparkles />}
            title="Proven Results"
            text="Students achieve more"
          />
        </section>
        ...
        <section className="quote-card">
          ...
          <div>
            ...
            <span>
              Her lessons are easy to understand and very engaging. Highly
              recommended.
            </span>
        ...
        <section className="content-section" id="about">
          <div>
            ...
            <p>
              Choose a subject, find a time that works, and book a session in a
              few clicks. Teachers manage subjects and availability from their
              dashboard.
            </p>
          </div>
          ...
          <div className="mini-cards">
            <Feature
              ...
              text="English, writing, business, and more"
            />
            <Feature
              icon={<Clock3 />}
              title="Live Availability"
              text="Only open teacher slots are bookable"
            />
          </div>
        </section>
      </main>
      ...
      {mode && (
        <Auth mode={mode} close={() => setMode(null)} change={setMode} />
      )}
    </>
  )
}
...
function Auth({ mode, close, change }: AuthProps) {
  ...
  async function submit(event: React.FormEvent<HTMLFormElement>) {
    ...
    if (mode === 'register' && !result.data.session) {
      setError('Account created. Check your email to confirm it.')
      return
    }
  ...
  return (
    <div className="modal-backdrop">
      <div className="auth-modal">
        ...
        <p>
          {mode === 'login'
            ? 'Log in to view your learning schedule.'
